...
public partial class LapShopContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
       ...
       .HasKey(e => new { e.UserId, e.LoginProvider, e.Name });
        ...
        {
            entity.HasKey(e => e.FormId).HasName("PK__TbForm__FB05B7DDAE5F5AFF");
        ...
        {
            entity.HasKey(e => e.PermissionId).HasName("PK__TbPermis__EFA6FB2FDD03862F");
        ...
        {
            entity.HasKey(e => e.RolePermissionId).HasName("PK__TbRolePe__120F46BA13987A31");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__TbSettin__3214EC27C6E404D2");
